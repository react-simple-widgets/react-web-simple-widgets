...
const _coverHoverizontalStyle = {
    width: "100%",
    height: "auto",
};

// .reactEasyCrop_Cover_Vertical {
const _coverVerticalStyle = {
    width: "auto",
    height: "100%",
};

// .reactEasyCrop_CropArea {
const _cropAreaStyle = {
    position: "absolute",
    left: "50%",
    top: "50%",
...
const _cropAreaRoundStyle = {
    borderRadius: "50%",
};

//   .reactEasyCrop_CropAreaGrid::before {
// const _cropAreaGridStyleBefore = {
//     content: " ",
//     boxSizing: "border-box",
//     position: "absolute",
//     border: "1px solid rgba(255, 255, 255, 0.5)",
            ...
            >
                {image ? (
                    <img
                        ...
                        style={{
                            ..._imageStyle,
                            ...(objectFit === "contain" && _containStyle),
                            ...(objectFit === "horizontal-cover" && _coverHoverizontalStyle),
                            ...(objectFit === "vertical-cover" && _coverVerticalStyle),
                            ...mediaStyle,
                            transform:
                ...
                {this.state.cropSize && (
                    <div
                        style={{
                            ...cropAreaStyle,
                            ...(cropShape === "round" && _cropAreaRoundStyle),
                            ..._cropAreaStyle,
