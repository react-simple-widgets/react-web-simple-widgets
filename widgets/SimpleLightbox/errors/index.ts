export function dispatchError(e) {
    console.error(e);
    console.warn(
        "An error as occurred with Simple React Lightbox. Make sure you wrapped your App with the <SimpleReactLightbox> component and then use the <LightboxWrapper> component."
    );
}
