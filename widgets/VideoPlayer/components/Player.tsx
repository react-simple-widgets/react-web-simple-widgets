...
type Props = {
    ...
    onPause?: (evt?) => void,
    onProgress?: (evt?) => void,
    onDurationChange?: (evt?) => void,
    onError?: (evt?) => void,
    onSuspend?: (evt?) => void,
    onAbort?: (evt?) => void,
    onEmptied?: (evt?) => void,
    onStalled?: (evt?) => void,
    onLoadedMetadata?: (evt?) => void,
    onLoadedData?: (evt?) => void,
    onTimeUpdate?: (evt?) => void,
    onRateChange?: (evt?) => void,
    onVolumeChange?: (evt?) => void,
...
export default class Player extends React.Component<Props> {
    ...
    static contextTypes = { store: {} as any };
    ...
    getStyle() {
        ...
        if (propsWidth !== undefined) {
            ...
            width = parseFloat(propsHeight + "") / ratioMultiplier;
        } else {
