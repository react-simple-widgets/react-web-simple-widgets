...
class ClosedCaptionButton extends React.Component<Props, State> {

    static defaultProps = defaultProps;
    static displayName = "ClosedCaptionButton";
    ...
    getTextTrackItems() {
        ...
        const tracks: any[] = Array.from(textTracks || []);
    ...
    handleSelectItem(index) {
        ...
        Array.from(textTracks).forEach((textTrack: any, i) => {
